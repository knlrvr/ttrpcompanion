...
<a name="releases"></a>
## Releases
[!v1.0](https://img.shields.io/badge/version-1.0-blue) | ```7 Aug 2023``` & ```25 Aug 2023``` | ```Initial Release``` 
...
[!v1.1](https://img.shields.io/badge/version-1.1-green) | ```29 Aug 2023``` | ```Login Updates```
